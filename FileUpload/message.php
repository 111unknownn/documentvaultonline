...
$thisUserId = $_SESSION['user_id']; // Add this line to get the sender's user_id
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        if ($activityStmt->execute()) {
            ...
            $actionDescription = "$userName sent a message to $recipientName";
            ...
            $logStmt->bind_param("issss", $thisUserId, $actionDescription, $logTimestamp, $userName, $currentAction);

            if ($logStmt->execute()) {
                // Create notification for the recipient
                $notificationMessage = "You have a new message from $userName";
