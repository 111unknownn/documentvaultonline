...
$activitiesQuery = "SELECT description, timestamp, status FROM activities WHERE user_id = ? ORDER BY timestamp DESC";
$activitiesStmt = $conn->prepare($activitiesQuery);
$activitiesStmt->bind_param("i", $_SESSION['user_id']);
  ...
  <div class="wrapper">
    ...
    <div class="d-flex" style="background-color:; border-bottom: 1px solid  #e4e4e4; margin-top:-9px;">
      ...
      <ul class="sidebar-nav">
        <a href="../panels/documents" class="sidebar-link">
          <i class="fa-solid fa-file pe-2"></i>
          <span style="color:black; font-weight:bold; margin-right:10px;">Documents</span>
        </a>
        </li>
      ...
      <nav class="navbar navbar-expand px-3 border-bottom">
        ...
        <div class="navbar-collapse navbar">
          <ul class="navbar-nav">
            ...
            <!-- Recent activity -->
            <li class="nav-item dropdown">
              <a href="#" class="nav-link dropdown-toggle" id="activityDropdown" role="button" data-bs-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <i class="lni lni-recent" style="color:black;"></i>
                <!-- Recent activity badge -->
                <span class="badge bg-info" id="activityBadge"><?php echo count($activities); ?></span>
              ...
              <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="activityDropdown" id="activityMenu">
                ...
                <li class="dropdown-item activity-item">
                  <span><?php echo htmlspecialchars($activity['description']); ?></span>
                  <span class="activity-timestamp"><?php echo htmlspecialchars($activity['timestamp']); ?></span>
...
<div class="modal fade" id="settingsModal" tabindex="-1" role="dialog" aria-labelledby="settingsModalLabel"
 ...
 <!-- Modal of message!!! -->
 <div class="modal fade" id="sendMessageModal" tabindex="-1" role="dialog" aria-labelledby="sendMessageModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <form action="../FileUpload/message" method="POST" enctype="multipart/form-data">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color:white;">
                    <h5 class="modal-title" style="color:black;" id="sendMessageModalLabel">Send Message or File</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="hidden" class="form-control" id="sender" name="sender" value="<?php echo isset($_SESSION['user_name']) ? $_SESSION['user_name'] : ''; ?>">
                        <p>Sender: <?php echo isset($_SESSION['user_name']) ? $_SESSION['user_name'] : ''; ?></p>
                    </div>

                    <div class="form-group">
                        <label for="recipient">Recipient:</label>
                        <input type="text" class="form-control" id="recipient" name="recipient" placeholder="Search recipient..." autocomplete="off" required>
                    ...
                    <button type="submit" class="btn btn-primary" id="submitButton" style="margin-top: 10px; background-color:darkorange; color:black; border-style:none;">Send</button>
