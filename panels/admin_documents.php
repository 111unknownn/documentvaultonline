...
<div class="wrapper">
    ...
    <aside id="sidebar">
        ...
        <ul class="sidebar-nav">
            <li class="sidebar-item <?php echo $currentPage === 'admin_documents' ? 'active' : ''; ?>">
                <a href="admin_documents.php" class="sidebar-link">
    ...
    <div class="main" style="background-color: #CED4DA;">
        ...
        <main class=" rounded m-3 p-3 vh-100 overflow-auto" style="background-color: #CED4DA;">
            ...
            <header class="w-100 mb-3 d-flex align-items-center justify-content-between gap-2">
                ...
                <aside>
                    <form action="admin_documents.php" method="get"
            ...
            $sql = $filterBy === "Owned" ? "SELECT * FROM `document` WHERE `user_id`=$thisUserId AND (`title` LIKE '%$search%' OR `tags` LIKE '%$search%' OR `author` LIKE '%$search%' OR `category` LIKE '%$search%')" : "SELECT * FROM `document` WHERE `title` LIKE '%$search%' OR `tags` LIKE '%$search%'  OR `author` LIKE '%$search%' OR `category` LIKE '%$search%'";
            // Sort order
        ...
        <script type="text/javascript">
            ...
            $('#sortByDocuments').on('change', function () {
                ...
                window.location.href = "admin_documents.php?sort=" + sortByValue + "&fb=" + filterByValue + "&q=" + searchValue;
            });
