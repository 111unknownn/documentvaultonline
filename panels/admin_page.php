...
// Function to fetch the count of unread chats for the current user
function fetchUnreadChatCount($conn)
{
...
// Fetch unread chat count on page load
$unreadChatCount = fetchUnreadChatCount($conn);
...
<body>
    <div class="wrapper">
        <aside id="sidebar">
            ...
            <ul class="sidebar-nav" style="background-color: ">
                <a href="admin_documents" class="sidebar-link">
                ...
                <li class="sidebar-item">
                    <a href="../user_management/logs.php" class="sidebar-link">
                        ...
                        <span style="color:black; font-weight:bold; margin-left:6px;">Logs </span>
                    </a>
                </li>
            </ul>
...
<main class="content px-3 py-4">
                        ...
                        <div class="card-body p-0 d-flex flex-fill">
                            <div class="row g-0 w-100">
                                <div class="p-3 m-1">
                                    ...
                                    <p class="dashboard-text mb-0">Admin Dashboard </p>
                                    <br>
                                </div>
                            </div>
                        </div>
    ...
    <section class="main" style="background-color:#CED4DA;">

        <div class="main-top"></div>
        <div class="row justify-content-left" style="background-color: #CED4DA;">
            <!-- Added justify-content-center class -->
            <!-- Total Users Card -->
            <div class="col-xl-2 col-md-4">
                <div class="card mb-4" style="text-align:left; height: 170px; width: 400px; margin-left:3px;">
                    <!-- Adjusted height and width -->
                    <div class="card-header text-black" style="font-style:Roboto; font-weight:bold;">
                        TOTAL USERS
                    </div>
                    <div class="card-body">
                        <img src="images/users.svg" alt="User Logo" class="card-logo mb-3">
                        <h5 class="card-title" style="text-align:center; " id="totalUsersCardBody">
                            Loading...</h5>
                    </div>
                </div>
            </div>
            ...
            <!-- Total Files -->
            <div class="col-xl-2 col-md-4">
                <div class="card mb-4" style="text-align:left; height: 170px; width: 400px; margin-left:150px;">
                    <!-- Adjusted height and width -->
                    <div class="card-header text-black" style="font-style:Roboto; font-weight:bold;">
                        TOTAL FILES
                    </div>
                    <div class="card-body">
                        <img src="images/files.svg" alt="Files Logo" class="card-logo mb-3">
                        <h5 class="card-title" style="text-align:center;" id="totalFilesCardBody">Loading...
                        </h5>
                    </div>
                </div>
            </div>
            ...
            <!-- Owned Files -->
            <div class="col-xl-2 col-md-4">
                <div class="card mb-4" style="text-align:left; height: 170px; width: 400px; margin-left:300px;">
                    <!-- Adjusted height and width -->
                    <div class="card-header text-black" style="font-style:Roboto; font-weight:bold;">
                        OWNED FILES
                    </div>
                    <div class="card-body">
                        <img src="images/files.svg" alt="Placeholder Image" class="card-logo mb-3">
                        <h5 class="card-title" style="text-align:center;" id="yourTotalFiles">Loading...
                        </h5>
                    </div>
                </div>
            </div>
        ...
        <!-- Your JavaScript to fetch owned files -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="profileUpdateForm">
                            ...
                            <button type="button" style="background-color:#D59D80;" class="btn"
                                ...
                                while ($rows = mysqli_fetch_assoc($result)) { ?>
                                    <div class="shadow p-3 rounded text-center border" style="width: 295px;">
                                        ...
                                        <img src="./images/<?php echo $fileImage ?>"
                                            class="<?php echo $fileClass ?? '' ?> blue-logo" alt="file" loading="lazy"
                                            width="130" height="70">
        ...
        <div class="modal fade" id="excelModal" tabindex="-1" role="dialog" aria-labelledby="categoryModalLabel"
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="background-color:white; color:black;">
                        <h5 class="modal-title" id="categoryModalLabel">Documents in EXCEL FILE Category
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
        ...
        <div class="modal fade" id="sendMessageModal" tabindex="-1" role="dialog"
            ...
            <form action="../FileUpload/admin_message.php" method="POST" enctype="multipart/form-data">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <input type="hidden" class="form-control" id="sender" name="sender"
                                    value="<?php echo isset($_SESSION['admin_name']) ? $_SESSION['admin_name'] : ''; ?>">
                                <p>Sender: <?php echo isset($_SESSION['admin_name']) ? $_SESSION['admin_name'] : ''; ?>
                                </p>
                            </div>
                    ...
                    <div class="modal-body">
                        <form id="uploadForm" class="shadow rounded p-3" enctype="multipart/form-data" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input required id="uploadKeywords" name="uploadKeywords" type="text"
                                    class="form-control" placeholder="ex: (documents, .ppt)">
                            </div>
        ...
        <script>
            ...
            $(document).ready(function () {
                function fetchUnreadCount() {
                    $.ajax({
                        url: 'fetch_unread_counts.php', // Update this path to the actual location of your PHP script
                        method: 'GET',
                        success: function (response) {
                            if (response.success) {
                                $('#chatNotificationCount').text(response.unread_count);
                            }
                        }
                    });
                }
                ...
                $('#openChatModalLink').on('click', function () {
                    $('#chatModal').modal('show');
                    // Assuming you have logic to determine the from_id
                    var from_id = 1; // Replace with the actual logic to get the from_id
